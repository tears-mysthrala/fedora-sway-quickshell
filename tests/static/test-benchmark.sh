...
grep -Fq 'cpu_seconds_delta' "$ROOT/benchmark.sh"
grep -Fq 'B_nmcli_monitor' "$ROOT/benchmark.sh"
...
grep -Fq 'systemctl --user stop fedora-sway-idle.service' "$ROOT/benchmark.sh"
grep -Fq 'systemctl --user start fedora-sway-idle.service' "$ROOT/benchmark.sh"
